...
meta_info <- meta_info_from_labels(filtered)
...
normal <- normalize_by_cpm(filtered)
head(normal)
...
normalized_counts <- deseq_normalize(filtered, meta_info)
...
sample_distributions <- plot_sample_distributions(filtered, scale_y_axis = TRUE)
